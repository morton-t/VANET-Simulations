...
class TraCIDemo11pMessage : public ::veins::BaseFrame1609_4
{
  protected:
    ...
    omnetpp::opp_string *suspectedGhosts = nullptr;
    size_t suspectedGhosts_arraysize = 0;
    LAddress::L2Type senderAddress = -1;
    int serial = 0;
  ...
  public:
    ...
    virtual void setSuspectedGhostsArraySize(size_t size);
    virtual size_t getSuspectedGhostsArraySize() const;
    virtual const char * getSuspectedGhosts(size_t k) const;
    virtual void setSuspectedGhosts(size_t k, const char * suspectedGhosts);
    virtual void insertSuspectedGhosts(const char * suspectedGhosts);
    virtual void insertSuspectedGhosts(size_t k, const char * suspectedGhosts);
    virtual void eraseSuspectedGhosts(size_t k);
