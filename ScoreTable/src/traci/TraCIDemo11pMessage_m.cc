...
void TraCIDemo11pMessage::copy(const TraCIDemo11pMessage& other)
{
    ...
    delete [] this->suspectedGhosts;
    this->suspectedGhosts = (other.suspectedGhosts_arraysize==0) ? nullptr : new omnetpp::opp_string[other.suspectedGhosts_arraysize];
    suspectedGhosts_arraysize = other.suspectedGhosts_arraysize;
    for (size_t i = 0; i < suspectedGhosts_arraysize; i++) {
        this->suspectedGhosts[i] = other.suspectedGhosts[i];
    }
...
void TraCIDemo11pMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    b->pack(suspectedGhosts_arraysize);
    doParsimArrayPacking(b,this->suspectedGhosts,suspectedGhosts_arraysize);
...
void TraCIDemo11pMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    delete [] this->suspectedGhosts;
    b->unpack(suspectedGhosts_arraysize);
    if (suspectedGhosts_arraysize == 0) {
        this->suspectedGhosts = nullptr;
    } else {
        this->suspectedGhosts = new omnetpp::opp_string[suspectedGhosts_arraysize];
        doParsimArrayUnpacking(b,this->suspectedGhosts,suspectedGhosts_arraysize);
    }
...
size_t TraCIDemo11pMessage::getSuspectedGhostsArraySize() const
{
    return suspectedGhosts_arraysize;
}

const char * TraCIDemo11pMessage::getSuspectedGhosts(size_t k) const
{
    if (k >= suspectedGhosts_arraysize) throw omnetpp::cRuntimeError("Array of size suspectedGhosts_arraysize indexed by %lu", (unsigned long)k);
    return this->suspectedGhosts[k].c_str();
}

void TraCIDemo11pMessage::setSuspectedGhostsArraySize(size_t newSize)
{
    omnetpp::opp_string *suspectedGhosts2 = (newSize==0) ? nullptr : new omnetpp::opp_string[newSize];
    size_t minSize = suspectedGhosts_arraysize < newSize ? suspectedGhosts_arraysize : newSize;
    for (size_t i = 0; i < minSize; i++)
        suspectedGhosts2[i] = this->suspectedGhosts[i];
    delete [] this->suspectedGhosts;
    this->suspectedGhosts = suspectedGhosts2;
    suspectedGhosts_arraysize = newSize;
}

void TraCIDemo11pMessage::setSuspectedGhosts(size_t k, const char * suspectedGhosts)
{
    if (k >= suspectedGhosts_arraysize) throw omnetpp::cRuntimeError("Array of size  indexed by %lu", (unsigned long)k);
    this->suspectedGhosts[k] = suspectedGhosts;
}

void TraCIDemo11pMessage::insertSuspectedGhosts(size_t k, const char * suspectedGhosts)
{
    if (k > suspectedGhosts_arraysize) throw omnetpp::cRuntimeError("Array of size  indexed by %lu", (unsigned long)k);
    size_t newSize = suspectedGhosts_arraysize + 1;
    omnetpp::opp_string *suspectedGhosts2 = new omnetpp::opp_string[newSize];
    size_t i;
    for (i = 0; i < k; i++)
        suspectedGhosts2[i] = this->suspectedGhosts[i];
    suspectedGhosts2[k] = suspectedGhosts;
    for (i = k + 1; i < newSize; i++)
        suspectedGhosts2[i] = this->suspectedGhosts[i-1];
    delete [] this->suspectedGhosts;
    this->suspectedGhosts = suspectedGhosts2;
    suspectedGhosts_arraysize = newSize;
}

void TraCIDemo11pMessage::insertSuspectedGhosts(const char * suspectedGhosts)
{
    insertSuspectedGhosts(suspectedGhosts_arraysize, suspectedGhosts);
}

void TraCIDemo11pMessage::eraseSuspectedGhosts(size_t k)
{
    if (k >= suspectedGhosts_arraysize) throw omnetpp::cRuntimeError("Array of size  indexed by %lu", (unsigned long)k);
    size_t newSize = suspectedGhosts_arraysize - 1;
    omnetpp::opp_string *suspectedGhosts2 = (newSize == 0) ? nullptr : new omnetpp::opp_string[newSize];
...
unsigned int TraCIDemo11pMessageDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISARRAY | FD_ISEDITABLE,    // FIELD_suspectedGhosts
...
int TraCIDemo11pMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 's' && strcmp(fieldName, "suspectedGhosts") == 0) return base+4;
...
int TraCIDemo11pMessageDescriptor::getFieldArraySize(void *object, int field) const
{
    ...
    switch (field) {
        case FIELD_suspectedGhosts: return pp->getSuspectedGhostsArraySize();
        default: return 0;
    }
}
...
std::string TraCIDemo11pMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_suspectedGhosts: return oppstring2string(pp->getSuspectedGhosts(i));
...
bool TraCIDemo11pMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_suspectedGhosts: pp->setSuspectedGhosts(i,(value)); return true;
